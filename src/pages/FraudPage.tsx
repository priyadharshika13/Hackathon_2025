...
export default function FraudPage() {
  ...
  return (
    <div className="fixed inset-0 bg-black overflow-hidden">
      ...
      {/* Floating Elements */}
      <motion.div
        className="absolute top-1/4 left-10 w-20 h-20 bg-red-500/20 rounded-full blur-xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      <motion.div
        className="absolute bottom-1/4 right-10 w-16 h-16 bg-yellow-400/20 rounded-full blur-xl"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.4, 0.2, 0.4],
        }}
